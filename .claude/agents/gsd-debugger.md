...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude
                  → checks /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done
                  → writes to /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/hooks/
...
@/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
