...
Reference full template: `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/state.md`.
