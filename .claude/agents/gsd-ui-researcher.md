...
Use template from `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
