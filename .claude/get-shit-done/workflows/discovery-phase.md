...
See /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/discovery.md
...
Use /var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/get-shit-done/templates/discovery.md.
