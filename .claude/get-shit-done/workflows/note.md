...
- **Global scope**: `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/notes/`)
...
2. Glob `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/var/www/wordcloud-app-v2/server/aerocloud-engine/.claude/notes/` — works in any directory
