---
title: Architecture Research (Gemini)
tags: [research, architecture, polyglot, python]
...
- [research/stack.md](research/stack.md) — Konkrete Bibliotheken und Versionen
- [research/pitfalls.md](research/pitfalls.md) — Architektur-Risiken
- [research/summary.md](research/summary.md) — Synthese
- [knowledge/project-specification.md](knowledge/project-specification.md) — Constraints und Key Decisions
- [knowledge/requirements-v1.md](knowledge/requirements-v1.md) — 109 Requirements pro Phase
