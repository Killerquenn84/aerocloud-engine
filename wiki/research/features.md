---
title: Features Research (Gemini)
tags: [research, features, blueprint, maturity]
...
- [research/architecture.md](research/architecture.md) — Wie Features integriert werden
- [research/pitfalls.md](research/pitfalls.md) — Feature-spezifische Risiken
- [source-blueprint.md](source-blueprint.md) — Blueprint als Feature-Quelle
- [differentiable-rendering.md](differentiable-rendering.md) — Inner Loop Feature
- [map-elites.md](map-elites.md) — Outer Loop Feature
