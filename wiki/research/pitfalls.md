---
title: Pitfalls Research (Gemini)
tags: [research, pitfalls, risks, mitigation]
...
- [research/stack.md](research/stack.md) — Stack-bedingte Risiken
- [research/architecture.md](research/architecture.md) — Architektur-Smells
- [corrections/2026-04-07-stack-hallucinations.md](corrections/2026-04-07-stack-hallucinations.md) — Konkrete Korrekturen
- [adam-optimizer.md](adam-optimizer.md) — Vanishing Gradients Risiko
- [collision-detection.md](collision-detection.md) — Quadtree-Tiefe Risiko
